 ...
 */
var Launchpad = function (inport, outport, initAnimation) {
    ...
    this.init = function () {
        ...
        console.log("running launchpad: " + this.output.getPortName(outport));

        this.initialize();
    };

    console.log("setting up Launchpad on port:" + outport);
    this.init();
...
Launchpad.prototype.renderBytes = function (bytes, which, color) {
...
exports.connect = function (port, port2, initAnimation) {
    return new Launchpad(port, port2, initAnimation);
};
